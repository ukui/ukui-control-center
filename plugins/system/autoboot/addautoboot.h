...
public:
    explicit AddAutoBoot(QStringList addedList, QWidget *parent = 0);
    ~AddAutoBoot();

    void resetBeforeClose();
    void refreshList(QString filename);
    void get_all_files(QString path);
    void build_app_item(QString path);
