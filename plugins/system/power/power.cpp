...
void Power::setupComponent() {
    ...
    // 电脑睡眠延迟
    sleepStringList  << tr("never") << tr("10 min") << tr("20 min") << tr("30 min") << tr("1h") << tr("2h") << tr("5h");
    ...
    // 显示器关闭延迟
    closeStringList  << tr("never") << tr("1 min") << tr("5 min") << tr("10 min") << tr("20 min") << tr("30 min") << tr("1h") << tr("2h");
