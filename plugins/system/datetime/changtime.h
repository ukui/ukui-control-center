...
private:
    ...
    int m_minute;
    int m_second;
    ScrollTimeChooser* pWidgetYear;
    ScrollTimeChooser* pWidgetMonth;
    ScrollTimeChooser* pWidgetDay;
    ScrollTimeChooser* pWidgetHour;
    ScrollTimeChooser* pWidgetMin;
    ScrollTimeChooser* pWidgetSecond;
