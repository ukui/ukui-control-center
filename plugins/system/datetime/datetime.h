...
private:
    ...
    SwitchButton *m_ntpBtn = nullptr;
    QLabel *m_ntpLabel = nullptr;
...
private slots:
    ...
    void showendLabel();
    void hidendLabel();
    void synctime_slot(bool);
    void close_sync();
    void change_calender_slot(int);
    void change_date_slot(int);
    void change_time_slot(int);
private:
    void loadHour();
