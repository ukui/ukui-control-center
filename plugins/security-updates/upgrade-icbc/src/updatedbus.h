...
#define KYLIN_SYSTEM_UPGRADE_PATH "/com/kylin/systemupgrade"

#define KYLIN_SYSTEM_UPGRADE_SERVICE "com.kylin.systemupgrade"

#define KYLIN_SYSTEM_UPGRADE_INTERFACE "com.kylin.systemupgrade.interface"
...
public:
    ...
    bool DistUpgradeAll(bool status);
    bool DistUpgradePartial(bool status,QString pkgName);
    bool DistUpgradeSystem(bool status);
    bool CancelDownload();
