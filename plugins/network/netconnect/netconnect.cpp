...
//void UserInfo::deleteNetworkDone(QString networkname){
//    QListWidgetItem * item = AvailableNetworkMap.value(networkname);
...
//    ui->listWidget->setFixedHeight((AvailableNetworkMap.count()) * ITEMHEIGH);
//}
