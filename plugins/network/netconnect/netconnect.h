...
public:
    ...
    void runExternalApp(const int& type = 0, const QString& netname = "");
...
private:
    ...
    bool handle_open_wifi_switch = false;

    QMap<QString, int> connectedWifi;
    QMap<QPair<QString, bool>, int> wifiList;     //wifi list<name,Signal strength>
    QStringList lanList;            // list of wired network
    QString connectedLan;
    QGSettings *m_gsettings = nullptr;
    QGSettings *m_nmgsettings = nullptr;
    QString m_activateWifi;
    QDBusInterface * m_kylinnm_interface = nullptr;
...
private slots:
    ...
    void getNetList();
    void wifiChangedSlot(const QString &active_wifi);
