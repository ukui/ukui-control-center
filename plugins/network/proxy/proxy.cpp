...
void Proxy::initSearchText() {
    //~ contents_path /proxy/Proxy
    ui->titleLabel->setText(tr("Proxy"));
    ...
    ui->label_10->setText(tr("Ftp Proxy"));
    //~ contents_path /proxy/Socks Proxy
    ui->label_12->setText(tr("Socks Proxy"));
}

void Proxy::setupStylesheet(){
    ui->urlLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->httpHostLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->httpPortLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->httpsHostLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->httpsPortLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->ftpHostLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->ftpPortLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->socksHostLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
    ui->socksPortLineEdit->setStyleSheet("QLineEdit{background: palette(button); border: none; border-radius: 8px; font-size: 14px; color: palette(text);}");
}
...
void Proxy::initIgnoreHostStatus(){
    ...
    if (ignorehost.at(0) == "localhost") {
        ui->ignoreHostTextEdit->setPlainText("");
    } else {
...
//    ui->urlFrame->setVisible(autoChecked);
    ui->urlFrame->setEnabled(autoChecked);
...
//    ui->socksFrame->setVisible(manualChecked);
    ui->httpFrame->setEnabled(manualChecked);
    ui->httpsFrame->setEnabled(manualChecked);
    ui->ftpFrame->setEnabled(manualChecked);
    ui->socksFrame->setEnabled(manualChecked);
    ui->ignoreFrame->setEnabled(manualChecked);
