...
DigitalPhoneDialog::DigitalPhoneDialog(QString username ,QWidget *parent) : QWidget(parent),
    m_bgColor("#FFFFFF")
{
    this->resize(360, 529);
    m_username = username;
...
DigitalPhoneDialog::~DigitalPhoneDialog()
{

}

void DigitalPhoneDialog::initUI(){
...
void DigitalPhoneDialog::initConnect()
{
    connect(m_pNumbersBtn, &NumbersButton::numbersButtonPress, this, &DigitalPhoneDialog::onNumerPress);
}

void DigitalPhoneDialog::setQSS()
{
...
void DigitalPhoneDialog::showPromptMsg()
{
    m_pPromptMessage->show();
    m_pPromptMessageClone->hide();
}

void DigitalPhoneDialog::hidePromptMsg()
{
...
void DigitalPhoneDialog::onReset()
{
...
void DigitalPhoneDialog::onNumerPress(int btn_id)
{
    if(btn_id == 10)
    {
...
bool DigitalPhoneDialog::eventFilter(QObject *obj, QEvent *event){
...
//                QMessageBox::information(NULL,QString::fromLocal8Bit("点击"),QString::fromLocal8Bit("牛逼吗？"),QMessageBox::Yes|QMessageBox::No, QMessageBox::Yes);
    ...
    return DigitalPhoneDialog::eventFilter(obj, event);
}

void DigitalPhoneDialog::showEvent(QShowEvent *event)
{
    Q_UNUSED(event);
    setFocus();
}

void DigitalPhoneDialog::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
}

void DigitalPhoneDialog::drawBg(QPainter *painter)
{
    painter->save();
...
void DigitalPhoneDialog::keyPressEvent(QKeyEvent *ev)
{
    if (ev->key() == Qt::Key_0) {
        onNumerPress(0);
        return;
