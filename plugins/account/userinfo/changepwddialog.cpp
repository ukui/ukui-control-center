...
//    showOldPwdBtn->setStyleSheet("QPushButton{border-image: url(:/img/plugins/userinfo/pwdEncrypted.png);}"
...
//                              "QPushButton:pressed{border-image: url(:/img/plugins/userinfo/pwdUnscramble.png);}");
    ...
    connect(showOldPwdBtn, &QPushButton::clicked, this, [=]{
        if(isOldPwdVisibel){
            ...
            showOldPwdBtn->setStyleSheet("QPushButton{border-image: url(:/img/plugins/userinfo/pwdUnscramble.png);}");
        }
        ui->oldPwdLineEdit->setStyleSheet("QLineEdit{border-radius: 8px;"
                                          "background: palett(base);"
                                          "border: 2px solid #2FB3E8;}");
...
//    });
    connect(showPwdBtn, &QPushButton::clicked, this, [=]{
        if(isNewPwdVisibel){
            ...
            showPwdBtn->setStyleSheet("QPushButton{border-image: url(:/img/plugins/userinfo/pwdUnscramble.png);}");
        }
        ui->oldPwdLineEdit->setStyleSheet("QLineEdit{border-radius: 8px;"
                                          "background: palett(base);}");
        ui->pwdLineEdit->setStyleSheet("QLineEdit{border-radius: 8px;"
...
//    });
    connect(showSurePwdBtn, &QPushButton::clicked, this, [=]{
        if(isSurePwdVisibel){
            ...
            showSurePwdBtn->setStyleSheet("QPushButton{border-image: url(:/img/plugins/userinfo/pwdUnscramble.png);}");
        }
        ui->oldPwdLineEdit->setStyleSheet("QLineEdit{border-radius: 8px;"
                                          "background: palett(base);}");
        ui->pwdLineEdit->setStyleSheet("QLineEdit{border-radius: 8px;"
