...
**/
#ifndef DIGITALPHONEDIALOG_H
#define DIGITALPHONEDIALOG_H

#include "passwordbar.h"
#include "numbersbutton.h"
...
class DigitalPhoneDialog : public QWidget
{
    Q_OBJECT
public:
    explicit DigitalPhoneDialog(QString username,QWidget *parent = nullptr);
    ~DigitalPhoneDialog();
