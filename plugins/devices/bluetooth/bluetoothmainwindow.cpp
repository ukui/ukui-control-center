...
//    _MNormalWidgetTop->setStyleSheet("background:red;");
    ...
    _MNormalWidgetTopBottom->setStyleSheet("background:red;");
...
void BlueToothMainWindow::InitNormalWidgetTop()
{
    ...
    BtSwitchFrameLayout->addStretch(1);
...
void BlueToothMainWindow::InitNormalWidgetBottom()
{
    ...
    _MNormalWidgetTopBottomLayout->setContentsMargins(0,0,10,0);
    ...
    _MNormalWidgetTopBottomLayout->addWidget(_LoadIcon);
