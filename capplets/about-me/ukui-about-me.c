...
#include "ukui-about-me-fingerprint.h"
#include "marshal.h"
...
static void
about_me_load_photo (UkuiAboutMe *me)
{
	gchar         *file;
	GError        *error = NULL;
...
static void
about_me_update_photo (UkuiAboutMe *me)
{
	gchar         *file;
	GError        *error;
...
static void
about_me_load_info (UkuiAboutMe *me)
{
...
static void
about_me_image_clicked_cb (GtkWidget *button, UkuiAboutMe *me)
{
...
static void
about_me_image_changed_cb (GtkWidget *widget, UkuiAboutMe *me)
{
	me->have_image = TRUE;
	me->image_changed = TRUE;
	about_me_update_photo (me);
...
static void
about_me_button_clicked_cb (GtkDialog *dialog, gint response_id, UkuiAboutMe *me)
{
...
static void
about_me_passwd_clicked_cb (GtkWidget *button, UkuiAboutMe *me)
{
	GtkBuilder *dialog;

	dialog = me->dialog;
	ukui_about_me_password (GTK_WINDOW (WID ("about-me-dialog")));
}

static void
about_me_fingerprint_button_clicked_cb (GtkWidget *button, UkuiAboutMe *me)
{
...
about_me_setup_dialog (void)
{
	...
	me = g_new0 (UkuiAboutMe, 1);
	me->image = NULL;

	dialog = gtk_builder_new ();
	gtk_builder_add_from_file (dialog, UKUICC_UI_DIR "/ukui-about-me-dialog.ui", NULL);
