...
create_dialog (void)
{
	...
	GtkWidget *image;
	GError *error = NULL;
	static const gchar *uifile = UKUICC_UI_DIR "/ukui-keyboard-properties-dialog.ui";
...
setup_dialog (GtkBuilder * dialog)
{
	...
	/* Ergonomics */
	monitor = g_find_program_in_path ("ukui-typing-monitor");
	if (monitor != NULL) {
		g_free (monitor);
...
main (int argc, char **argv)
{
	...
	context = g_option_context_new (_("- UKUI Keyboard Preferences"));
