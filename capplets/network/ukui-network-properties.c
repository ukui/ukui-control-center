/* ukui-network-properties.c: network preferences capplet
 *
...
#define UKUICC_GNP_UI_FILE (UKUICC_UI_DIR "/ukui-network-properties.ui")
			        ...
			        GtkWidget *parent)
{
	...
	if (gtk_builder_add_objects_from_file (builder, UKUICC_GNP_UI_FILE,
	...
	capplet_set_icon (widget, "ukui-network-properties");
