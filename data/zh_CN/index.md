...
蓝牙模块提供了开关蓝牙、修改蓝牙名称、显示隐藏蓝牙任务图标、自动发现周围蓝牙设备、本机设备的可见性；与发现的蓝牙设备配对、连接、断开、移除蓝牙设备的基本功能，如图所示。

- 开关蓝牙：点击开启蓝牙按钮，对本机的蓝牙适配器开启和关闭

- 修改蓝牙名称：将鼠标在“修改图标”上单击，在弹出输入框输入想要的名称
...
6）触摸滚动方式(禁用滚动,边界滚动,中间区域双指滚动)，设置边界滚动时，垂直边界及水平边界滚动有效，设置为中间区域双指滚动时，垂直中间及水平中间滚动有效。
