...
_scale_box_new (GvcBalanceBar *bar)
{
        ...
        case BALANCE_TYPE_RL:
                str_lower = g_strdup_printf ("<small>%s</small>", _("Left"));
                str_upper = g_strdup_printf ("<small>%s</small>", _("Right"));
                break;
        case BALANCE_TYPE_FR:
                str_lower = g_strdup_printf ("<small>%s</small>", _("Rear"));
                str_upper = g_strdup_printf ("<small>%s</small>", _("Front"));
                break;
        case BALANCE_TYPE_LFE:
                str_lower = g_strdup_printf ("<small>%s</small>", _("Minimum"));
                str_upper = g_strdup_printf ("<small>%s</small>", _("Maximum"));
                break;
        default:
                                  ...
                                  GvcBalanceType btype)
{
        ...
        switch (btype) {
        case BALANCE_TYPE_RL:
                bar->priv->label = gtk_label_new_with_mnemonic (_("_Balance(_B):"));
                break;
        case BALANCE_TYPE_FR:
                bar->priv->label = gtk_label_new_with_mnemonic (_("_Fade(_F):"));
                break;
        case BALANCE_TYPE_LFE:
                bar->priv->label = gtk_label_new_with_mnemonic (_("_Subwoofer(_S):"));
                break;
        default:
                g_assert_not_reached ();
        }
